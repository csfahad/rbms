        ...
        <div className="flex justify-between h-16">
          <div className="flex items-center">
            <Link to="/" className="flex items-center">
              ...
              <span className="ml-2 text-xl font-bold text-primary">RailBooking</span>
            </Link>
          </div>
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <Link to="/search" className="px-3 py-2 text-gray-700 hover:text-primary transition-colors">
              Search Trains
            </Link>
            ...
            {isAuthenticated ? (
              <>
                {isAdmin ? (
                  <Link to="/admin/dashboard\" className="px-3 py-2 text-gray-700 hover:text-primary transition-colors">
                    Admin Dashboard
                  </Link>
                ) : (
                  <Link to="/user/bookings" className="px-3 py-2 text-gray-700 hover:text-primary transition-colors">
                    My Bookings
                  </Link>
                )}
