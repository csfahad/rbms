...
import { Train, Plus, Minus, Save } from 'lucide-react';
  ...
  return (
    <div className="bg-gray-50 min-h-screen py-10 fade-in">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-8">
          <h1 className="text-2xl font-bold text-gray-900">Add New Train</h1>
          <p className="text-gray-600 mt-2">Enter train details to add a new train to the system</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow-md p-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            ...
            <div>
              <label htmlFor="sourceCode" className="form-label">Source Station Code</label>
              <input
                type="text"
                id="sourceCode"
            ...
            <div>
              <label htmlFor="destinationCode" className="form-label">Destination Station Code</label>
              <input
                type="text"
                id="destinationCode"
                value={formData.destinationCode}
                onChange={(e) => setFormData(prev => ({ ...prev, destinationCode: e.target.value }))}
                className="form-input"
                required
              />
            </div>
          ...
          <div className="mb-6">
            <label className="form-label">Class Configuration</label>
            <div className="space-y-4">
              {formData.classes.map((cls, index) => (
                <div key={cls.type} className="grid grid-cols-1 md:grid-cols-3 gap-4 p-4 border rounded-lg">
                  <div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => handleClassChange(index, 'totalSeats', parseInt(e.target.value))}
                      className="form-input"
                      min="1"
                      required
                    />
                  ...
                  <div>
                    ...
                    <input
                      type="number"
                      value={cls.fare}
                      onChange={(e) => handleClassChange(index, 'fare', parseInt(e.target.value))}
                      className="form-input"
                      min="0"
                      required
                    />
