...
//         // Start a transaction
//         //@ts-ignore
//         const [train] = await sql.begin(async (sql) => {
//             // Create train
//             const [train] = await sql`
//                 INSERT INTO trains (
...
//                 )
//                 VALUES (
//                     ${trainData.number}, ${trainData.name}, ${trainData.source},
//                     ${trainData.sourceCode}, ${trainData.destination},
//                     ${trainData.destinationCode}, ${trainData.departureTime},
//                     ${trainData.arrivalTime}, ${trainData.duration},
//                     ${trainData.distance}, ${trainData.runningDays}
//                 )
//                 RETURNING *
//             `;
...
//                         train_id, class_type, total_seats, fare
//                     )
//                     VALUES (
//                         ${train.id}, ${classData.type},
//                         ${classData.totalSeats}, ${classData.fare}
//                     )
//                 `;
//             }
...
//                     source_code = ${trainData.sourceCode},
//                     destination = ${trainData.destination},
//                     destination_code = ${trainData.destinationCode},
...
//                     running_days = ${trainData.runningDays}
//                 WHERE id = ${id}
//                 RETURNING *
//             `;

//             // Delete existing classes
//             await sql`DELETE FROM train_classes WHERE train_id = ${id}`;
...
//             FROM trains t
//             LEFT JOIN train_classes tc ON t.id = tc.train_id
//             WHERE t.source_code = ${source}
//             AND t.destination_code = ${destination}
//             GROUP BY t.id
//         `;
...
//         // you would have a stations table in the database.
//         const stations = [
