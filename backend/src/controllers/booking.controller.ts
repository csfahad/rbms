...
//             // Get train and class details
//             const [trainClass] = await sql`
//                 SELECT tc.*, t.name as train_name, t.number as train_number,
//                        t.source, t.destination
//                 FROM train_classes tc
//                 JOIN trains t ON t.id = tc.train_id
//                 WHERE tc.train_id = ${bookingData.trainId}
//                 AND tc.class_type = ${bookingData.classType}
//             `;

//             if (!trainClass) {
//                 throw new Error("Train class not found");
//             }
...
//                 )
//                 VALUES (
//                     ${bookingData.userId}, ${bookingData.trainId}, ${pnr},
//                     ${bookingData.classType}, ${bookingData.travelDate},
//                     ${totalFare}, 'Confirmed'
//                 )
//                 RETURNING *
//             `;
...
//                     )
//                     VALUES (
//                         ${booking.id}, ${passenger.name}, ${passenger.age},
//                         ${passenger.gender}, ${seatNumber}
//                     )
//                 `;
//             }
...
//     travelDate: string
// ): Promise<string> {
//     // Get the last assigned seat number for this train, class and date
//     const [lastSeat] = await sql`
...
//     let seatNumber = 1;
//     if (lastSeat) {
//         seatNumber = parseInt(lastSeat.seat_number.split("-")[1]) + 1;
//     }
